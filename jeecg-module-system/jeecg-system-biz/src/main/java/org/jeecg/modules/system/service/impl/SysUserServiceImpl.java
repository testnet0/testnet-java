...
//		}
	...
	@Override
	public void randomPassword(String password) {
		SysUser testnet = getUserByName("TestNet");
		testnet.setPassword(password);
		changePassword(testnet);
		SysUser admin = getUserByName("admin");
