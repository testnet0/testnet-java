# 优化任务扫描空间
ALTER TABLE `lite_flow_sub_task`
    MODIFY COLUMN `sub_task_param` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '子任务参数' AFTER `sys_org_code`;
# masscan增加域名扫描
UPDATE lite_flow_chain set asset_type = 'ip,sub_domain' where id = '1806627814112346114';
# 修复masscan运行错误 增加域名扫描
UPDATE lite_flow_script set script_data ='import com.alibaba.fastjson.JSON;
